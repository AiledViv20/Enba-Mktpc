    ...
    return ( 
        <>
            <Flex flexDirection={"column"}>
                ...
                <Accordion allowMultiple border={"transparent"} allowToggle={false}>
                    <AccordionItem>
                        <AccordionButton onClick={() => toggleAccordion()} bg={"#F4F4F4"} mt={5} border={"1px solid #B9B9B9"} borderRadius={"5px"}>
