...
import { listSearchCategories } from '../../resource';
...
const Categories = (props) => {
    ...
    return ( 
        <>
            ...
            <Box id='proyecto' color={"#424242"} w="full" mx="auto" maxW="3x1" {...props} borderRadius={"8px"} padding={"2rem 5%"}  position="relative">
                <Flex>
                ...
                <Flex width={"100%"} mt={10}>
                    <Flex width={"25%"} flexDirection={"column"}>
                        ...
                        <Flex mt={8} flexDirection={"column"}>
                            ...
                            <Flex flexDirection={"column"} bg={"#EFEFEF"} pl={"15px"} pb={"15px"} pt={"25px"} borderRadius={"0px 0px 5px 5px"} border={"1px solid #B9B9B9"}>
